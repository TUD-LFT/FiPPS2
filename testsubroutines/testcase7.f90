...
!
subroutine testcase7 (testcase)
			
NOCH NICHT ZU ENDE GEÄNDERT !!!
...
integer			:: numnodes=anzelemproquadkante*2+1 	! Knoten pro Rand
integer			:: anzRB=2*numnodes+2*(numnodes-2)
