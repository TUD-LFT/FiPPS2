...
!
subroutine testcase11 (testcase)
...
! Input + Output
!
integer, parameter		:: anzelemlaenge=50
integer, parameter		:: anzelembreite=50
double precision, parameter	:: elemlaenge = 0.4D0
double precision, parameter	:: elembreite = 0.4D0
double precision, parameter	:: fakelemdicke=0.1d0
...
do ii=1,anzknotenbreite
   do jj=1,anzknotenlaenge	! zuerst über länge
	 ...
	 if (mod(jj,2) > 0) then	! jj ungerade
