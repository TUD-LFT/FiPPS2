...
!
subroutine testcase2 (testcase)
			
! =================================================================================================
!
!	Header:		subroutine defining testcase2
!
!	Content:	1 tria3-element rotated by 45deg in x-y-plane
!			1 force in element-y-direction on node 3
...
nodes(2)%nid         = 2
nodes(2)%cid         = 0
nodes(2)%coords(1:3) = (/ 1.7071068D0, 1.7071068D0, 0.D0 /)

nodes(3)%nid         = 3
nodes(3)%cid         = 0
nodes(3)%coords(1:3) = (/ 0.64644659D0, 2.0606604D0, 0.D0 /)
...
forces(1)%nid = 3
forces(1)%cid = 0
forces(1)%fac = 7.071067812
forces(1)%ni  = (/ -1.D0, 1.D0, 0.D0 /)
