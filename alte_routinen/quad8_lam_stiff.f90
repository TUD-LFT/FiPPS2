...
!
subroutine quad8_lam_stiff(pcompID,area,node_coords,quad8_K)
...
!
  ...
  do ii=1,numgausspoints
    ...
    call quad8_iso_bmat(xi_vec(ii), eta_vec(ii), zeta_vec(ii), node_coords, thickness, normalVec, nodeTransMat, bmat, detJac, transMat)
...
!  call write_quad_matrix(quad8_K, 48,  'Kel                 ', 'beide')

  deallocate(xi_vec, eta_vec, zeta_vec)
  deallocate(  w_xi,   w_eta,   w_zeta)

end subroutine quad8_lam_stiff
